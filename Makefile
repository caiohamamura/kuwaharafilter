...
# translation
SOURCES = kuw_filter.py ui_kuw_filter.py __init__.py kuw_filterdialog.py
#TRANSLATIONS = i18n/kuw_filter_en.ts
TRANSLATIONS = 
...
PY_FILES = kuw_filter.py kuw_filterdialog.py __init__.py

EXTRAS = icon.png 

UI_FILES = ui_kuw_filter.py
