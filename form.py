...
class Ui_form1(object):
    def setupUi(self, form1):
        ...
        self.inputbox = QtGui.QComboBox(form1)
    ...
    def retranslateUi(self, form1):
        self.label.setText(QtCore.QCoreApplication.translate("form1", "Input raster", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.refb.setText("1")
        self.mem.setToolTip(QtGui.QApplication.translate("form1", "Maximum memory usage in MeB (it is an approximated value, since algorithm will only choose how many lines will be read at once).", None, QtGui.QApplication.UnicodeUTF8))
